...
export const gettingStartedFaq: FaqItem[] = [
  {
    id: "item1-1",
    question: `Why can't I text on the Scan2Pay Telegram channel? What should I do?`,
    answer: `When you join the Scan2Pay India community channel for the first time, you'll see a welcome message under the "Verify (For New Members)" topic. To start texting in the group, you need to click the verification prompt in that message and complete a simple CAPTCHA.`,
  },
  {
    id: "item1-2",
    question: `Where to Find Your Order or Transaction History on Scan2Pay`,
...
export const generalFaq: FaqItem[] = [
  {
    id: "item2-1",
    question: `What is Scan2Pay?`,
    answer: `Scan2Pay is a global platform that lets you easily buy, sell, and pay using USDC — securely and privately. It supports popular local payment methods like UPI, PIX, and QRIS, while keeping your funds fully in your control.`,
  },
  {
    id: "item2-2",
    question: `Is Scan2Pay safe to use?`,
    answer: `Yes. Scan2Pay is designed with user safety at its core. All merchants on the platform are personally verified. Before onboarding, they must submit zero-knowledge proofs (ZK-proofs) of their banking activity to prove that they are legitimate, active users with no history of bank freezes or fraudulent behavior. This makes merchant funds secure and transactions trustworthy.`,
  },
];
...
export const depositAndWithdrawFaq: FaqItem[] = [
  {
    ...
    answer: `Yes – all transactions on Scan2Pay are completely gasless, including deposits, withdrawals, and trades when using your in-app wallet on the Base network.`,
  },
  {
    id: "item4-2",
...
export const referAndEarnFaq: FaqItem[] = [
  {
    id: "item5-1",
    question: `What is Refer & Earn on Scan2Pay?`,
    answer: `Refer & Earn is your chance to earn passive rewards by inviting trusted users to trade on Scan2Pay. Once eligible, you can generate a referral link, share it, and earn 1% of the total trading volume of users who join through your link.`,
  },
  {
    id: "item5-2",
...
export const transactionFaq: FaqItem[] = [
  {
    id: "item6-1",
    question: `Where can I view all my transactions on Scan2Pay?`,
