  ...
  return (
    <div className="fixed bottom-0 z-30 left-0 w-full shadow-[0_-3px_9px_#ddd4ee] ">
      <div className="max-w-lg relative mx-auto px-4 py-3 md:py-5 flex justify-between">
        ...
        <button className="flex gap-2 hover:scale-105 hover:rotate-6 font-semibold hover:bg-[#5728A6] transition ease-in-out duration-300 bg-black rounded-lg cursor-pointer text-white px-5 py-2 items-center">
