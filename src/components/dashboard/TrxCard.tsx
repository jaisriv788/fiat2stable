...
const TrxCard: React.FC = () => {
  return (
    <div className="mt-10 mx-2 px-3 md:px-5 border-b-2 border-r border-purple-900 py-5 bg-purple-50 shadow-xl rounded-lg">
      ...
      <p className="text-xs text-gray-700 font-semibold">
        ...
        Increase the limit to do larger transactions in{" "}
