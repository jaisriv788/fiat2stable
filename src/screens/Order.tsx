      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow p-5 mt-6">
        ...
        <div className="relative w-full px-6 py-4">
          <div className="relative flex justify-between px-2">
            ...
            <div className="absolute top-1/2 left-2 w-[calc(100%-1rem)] h-1 border-t-2 border-dashed border-purple-300 -translate-y-1/2"></div>

            <div className="absolute top-1/2 left-2 w-[calc(50%-0.5rem)] h-1 bg-purple-600 -translate-y-1/2"></div>
          </div>
        </div>
        ...
        <div className="w-full mt-5 p-5 shadow-sm rounded-2xl border border-gray-200 bg-white">
          ...
          <div className="text-sm text-gray-700 space-y-2">
            ...
            <div className="flex justify-between">
              <span>You send</span>
              <span>0.136 USDC</span>
            </div>
            <div className="flex justify-between">
              <span>Fee</span>
              <span>0.125 USDC</span>
            </div>
            <div className="flex justify-between">
        ...
        <div className="flex items-start gap-2 mt-4 text-gray-600 text-xs p-3 bg-indigo-50 rounded-xl">
          ...
          <p>
            ...
            Please do not leave this page, otherwise the transaction will not
            complete.
          </p>
        </div>
      </div>
